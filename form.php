...
<html lang="ru">
  ...
  <head>
    ...
    <title>Задание номер 5 back</title>
...
.error_text {
  ...
  <body>
      ...
      <header>
        <p class="header-text">Почти гугл форма</p>
      </header>
      <main>
        <div>
                ...
                <label>
                  ...
                  <select name="ability[]"
                    ...
                    <option value="0" <?php echo (in_array("0",$ability)) ?  "selected" : ""  ; ?>>Мобильные приложения</option>
                    <option value="1" <?php echo (in_array('1',$ability)) ?  "selected" : ""  ; ?>>Создание сайтов</option>
                    <option value="2" <?php echo (in_array('2',$ability)) ?  "selected" : ""  ; ?>>Програмирование</option>
                  </select>
                </label><br />
